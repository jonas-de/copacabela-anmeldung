...
const EatingBehaviours: EatingBehaviour[] = Object.values(
  EatingBehavioursObject
);
...
const PhotoPermissionStates: Wording[] = Object.values(
  PhotoPermissionStatesObject
);

const CovidVaccinationStates: CovidVaccinationState[] = Object.values(
  CovidVaccinationStatesObject
);
